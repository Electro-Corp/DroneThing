...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        output->setGeometry(QRect(640, 100, 361, 351));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:26pt;\">Chinmay Tiwari's Tensorflow models Manage GUI </span></p></body></html>", Q_NULLPTR));
